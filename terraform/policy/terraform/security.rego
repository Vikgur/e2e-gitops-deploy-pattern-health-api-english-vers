...
deny[msg] {
  ...
  msg := "0.0.0.0/0 is forbidden in security group"
}
...
deny[msg] {
  ...
  msg := "Missing required tags Owner/Env/CostCenter on VM"
}

warn[msg] {
  not input.configuration.provider_config.yandex.version
  msg := "Provider yandex without fixed version (versions.tf)"
}
